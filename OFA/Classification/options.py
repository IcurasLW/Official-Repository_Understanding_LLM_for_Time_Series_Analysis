...
class Options(object):
    ...
    def __init__(self):
        ...
        # GPT4TS
        self.parser.add_argument('--patch_size', type=int, default=8, help='patch_size')
        ...
        self.parser.add_argument('--data_dir', default='/media/nathan/DATA/1Adelaide/Irregular_Time_Series/datasets/UEA/UWaveGestureLibrary',
                                 help='Data directory')
        ...
        self.parser.add_argument('--name', dest='experiment_name', default='UWaveGestureLibrary',
        ...
        self.parser.add_argument('--records_file', default='Classification_records.csv',
        ...
        self.parser.add_argument('--LLM', default='GPT2')
