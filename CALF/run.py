...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_id', type=str,  default='ETTh1_96_720_mixer', help='model id')
    parser.add_argument('--model', type=str, default='CALF',
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_gpt{}_{}_{}'.format(
                args.task_name,
                args.model_id,
                args.model,
                args.data,
