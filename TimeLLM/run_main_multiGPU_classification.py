...
accelerator.print(f'============================================ Task: {args.task_name}_{args.data_path} ============================================')
logging.basicConfig(
...
for ii in range(args.itr):
    ...
    if args.model == 'DLinear':
        ...
        model = TimeLLM.Model(args, n_classes, d_inp).float()
    ...
    for epoch in range(args.train_epochs):
        ...
        train_true = []
        y_pred = []
        for i, (batch_x, batch_y) in tqdm(enumerate(train_loader), disable=accelerator.is_main_process):
            iter_count += 1
