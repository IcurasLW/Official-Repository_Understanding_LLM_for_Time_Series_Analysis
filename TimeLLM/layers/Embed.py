...
class PatchEmbedding_classification(nn.Module):
    def __init__(self, d_model, patch_len, stride, dropout, d_inp):
        super().__init__()
        # Patching
        ...
        self.value_embedding = TokenEmbedding(patch_len*d_inp, d_model)
